...
export default function LoginPage() {
  ...
  const { login, register, oauthLogin, oauthError, clearOauthError } = useAuth();
              ...
              <div className="grid grid-cols-2 gap-3">
                {providers.google && (
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-gray-900 font-medium py-2 px-4 rounded-lg transition-colors"
                  >
                    <GoogleIcon />
                    Google
                  </button>
